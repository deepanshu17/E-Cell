...
<head>
	...
	<meta name="E-Cell" content="IIIT-H E-Cell" />
    ...
    <link rel="icon" href="<?php echo base_url().'assets/images/logo-ecell.png' ;?>" type="image/png"> 
    ...
    <!-- Document Title
    ============================================= -->
	<title>E Cell | IIIT Hyderabad</title>
        ...
        <header id="header" class="dark">
            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="index.html" class="standard-logo" data-dark-logo="<?php echo base_url().'assets/images/logo-ecell.png';?>">
                        <img src="<?php echo base_url().'assets/images/logo-ecell.png' ;?>" alt="E-Cell@IIIT-H"></a>
                        <a href="index.html" class="retina-logo" data-dark-logo="<?php echo base_url().'assets/images/logo-ecell@2x.png' ;?>"><img src="<?php echo base_url().'assets/images/logo-ecell@2x.png' ;?>" alt="E-Cell@IIIT-H"></a>
                    </div><!-- #logo end -->
